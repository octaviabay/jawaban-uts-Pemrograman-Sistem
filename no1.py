    ...
    if Pkp == '' :
        ...
        if lanjut.lower() != 'ok' :
            ...
            if 0 <= Penghasilan < 1000: 
                ...
                print("Pajak penghasilan anda tahun ini adalah", int(Tarifawal1 + Tarif2))
                attempt = 0
            elif 250000000 < Penghasilan <= 500000000:
                Tarif3 = (Penghasilan - 250000000) * 0.25
                print("Pajak penghasilan anda tahun ini adalah", int(Tarifawal1 + Tarifawal2 + Tarif3))
                attempt = 0
            elif Penghasilan > 500000000 :
                Tarif4 = (Penghasilan - 500000000) * 0.3
                print("Pajak penghasilan anda tahun ini adalah", int(Tarifawal1 + Tarifawal2 + Tarifawal3 + Tarif4))
                attempt = 0
            else :
                print('Maaf karakter yang anda masukkan salah. Silakan coba lagi.')
                attempt = 1
